...
ALSA(Advanced Linux Sound Architecture)简单使用
...
确定你的音频芯片是哪一个设备,这里以es8316为例,配置在i2s上,则确认为声卡`card0`,设备`1`.
